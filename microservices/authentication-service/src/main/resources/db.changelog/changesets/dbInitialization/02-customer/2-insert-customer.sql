...
INSERT INTO `customer` (name, password, username, is_active, email, mobile_number,address, status, wrong_password_attempt_count, two_factor_enabled, wrong_oto_auth_attempt_count,version)
VALUES
